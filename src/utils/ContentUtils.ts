...
export const handleApprove = async (
    ...
    try {
        ...
        const { mediaFile, status, ...vaueDetails } = values;
        ...
        await updateContent(record.id!, { script, type, status: true, ...vaueDetails });
        ...
        const contentsDB = await getContentsDisapprovedForScript();
        setContents(contentsDB);
